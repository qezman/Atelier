...
export function Hero() {
  return (
    ...
    >
      <div className="max-w-7xl mx-auto w-full px-6 sm:px-8 py-16 lg:py-24 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
        ...
        <div className="lg:col-span-7 flex flex-col justify-center pr-0 lg:pr-8">
          ...
          <h1 className="type-hero text-ink mb-8 max-w-2xl">
            Spaces that hold <em className="italic font-normal">memory</em>.
          </h1>

          <p className="type-body text-ink-secondary max-w-[380px] mb-10">
        ...
        <div className="lg:col-span-5 h-[420px] sm:h-[540px] lg:h-[640px] relative w-full overflow-hidden bg-border/40">
          <Image
