...
export function StudioStrip() {
  return (
    <section
      ...
      className="w-full bg-charcoal text-ink-on-dark py-16 sm:py-24 lg:py-32 px-5 sm:px-8 border-b border-border-on-dark"
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 lg:gap-16 items-center">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <p className="type-body text-ink-on-dark-secondary max-w-lg text-sm sm:text-base">
            Atelier operates across architecture, interior spatial design, and
            site ecology. Working from studios in Paris, Basel, and Kyoto, we
            collaborate directly with local stonemasons, master timber framers,
            and artisans to realize spaces of uncompromising tectonic integrity.
          </p>
